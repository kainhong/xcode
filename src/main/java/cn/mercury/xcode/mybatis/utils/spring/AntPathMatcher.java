...
package cn.mercury.xcode.mybatis.utils.spring;
...
public class AntPathMatcher implements PathMatcher {
    ...
    public AntPathMatcher(String pathSeparator) {
        notNull(pathSeparator, "'pathSeparator' is required");
    ...
    protected String[] tokenizePath(String path) {
        return SpringStringUtils.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
    }
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = SpringStringUtils.tokenizeToStringArray(pattern, this.pathSeparator, this.trimTokens, true);
        String[] pathParts = SpringStringUtils.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
    ...
    public String combine(String pattern1, String pattern2) {
        ...
        if (!SpringStringUtils.hasText(pattern1)) {
            return pattern2;
        }
        if (!SpringStringUtils.hasText(pattern2)) {
            return pattern1;
        }
