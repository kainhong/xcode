...
public class KeyWordsConstant {
    ...
    public static final Set<String> MYSQL = Collections.unmodifiableSet(new HashSet<>(KeyWords.MYSQL));


    private static class KeyWords {
        public static final List<String> MYSQL = Collections.unmodifiableList(
                Arrays.asList(
                        ...
                        "between", "config.form.basic.label.databaseType", "faults", "io_after_gtids", "modify", "primary", "rows", "subpartitions", "view",
                        ...
                        "cipher", "dual", "group_replication", "localtimestamp", "batslog.action.onOffButton.on", "remove", "snapshot", "truncate",
                        ...
                        "comment", "config.form.console.colorConfigForm.table.label.enable", "hour_microsecond", "longtext", "optionally", "replicate_do_db", "sql", "undo_buffer_size",
