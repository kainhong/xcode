...
import static cn.mercury.xcode.mybatis.model.LogConstant.*;
...
public class SqlFormatUtil {
    ...
    private static void print(Project project, Boolean printToConsole, ConsoleViewImpl console, List<String> sqlList,
                              List<String> paramsList, List<String> nameList, LogConfig service) {
        String dbTypeStr = JdbcConstants.MYSQL;
        DbType dbType = LogSettingState.getInstance(project).getDbType();
...
//        e.printStackTrace();
    ...
    public static void printKeyWord(ConsoleViewImpl consoleView, Project project, String keyWord, ConsoleViewContentType contentType) {
        ...
        boolean isEnabledKeyWordDefCol = LogSettingState.getInstance(project).isEnabledKeyWordDefCol();
     ...
     */
    private static void printSeparatorAndName(Project project, ConsoleViewImpl console, String name, LogConfig service) {
        console.print(StringUtil.encoding(LogConstant.SEPARATOR, project), ConsoleViewContentType.ERROR_OUTPUT);
     ...
     */
    @NotNull
    private static SQLUtils.FormatOption getFormatOption(LogConfig service) {
