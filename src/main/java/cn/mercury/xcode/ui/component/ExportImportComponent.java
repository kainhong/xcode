package cn.mercury.xcode.ui.component;
...
public class ExportImportComponent {
    ...
    private void handlerExportAction() {
        // 复制一份，避免篡改
        SettingsStorage settingsStorage = CloneUtils.cloneByJson(SettingsStorageService.getSettingsStorage());
        // 创建一行四列的主面板
    ...
    private void handlerImportAction() {
        SettingsStorage localSettings = SettingsStorageService.getSettingsStorage();
        SettingsStorage remoteSettings = service.importConfig();
